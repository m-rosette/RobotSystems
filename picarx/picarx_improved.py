...
class Picarx(object):
    ...
    def __init__(self, 
        ...
        for pin in self.motor_speed_pins:
            ...
            # pin.prescaler(self.PRESCALER)         --------------------------------------------------commented out the prescaler ---------------------------
        ...
        # Setting the motor speed to zero when the function is terminated
    ...
    def set_wheel_vel_scale(self, steering_angle):
        # PiCar measurements
        wheel_base = 11.6 # cm
        wheel_length = 9.5 # cm
    ...
    def forward(self,speed):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                ...
                self.set_motor_speed(1, speed)
                self.set_motor_speed(2, -1 * speed * self.set_wheel_vel_scale(current_angle))
