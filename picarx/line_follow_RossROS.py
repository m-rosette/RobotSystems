...
class RossROS_Exexute():
    ...
    def execute(self):
        while True:
            ...
            sensor_producer = Producer(self.sensor.grayscale_bus, output_buses=self.grayscale_bus, delay=0.1, termination_buses=self.terminator_bus, name="sensor producer")
